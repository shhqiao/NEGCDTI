...
def get_all_proteins(dataset_name):
    proteins = []
    data_file = "Data/" + dataset_name + "/" + "target_train" + ".txt"
...
if __name__ == '__main__':
    ...
    data_file = "Data/" + dataset_name + "/" + "target" + "_" + "train" + ".txt"
    save_name = "Data/" + dataset_name + "/" + "target" + "_" + str(k) + "_gram"
